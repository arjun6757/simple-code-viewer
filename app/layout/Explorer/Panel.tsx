...
export default function Panel() {
  ...
  return (
    <div
      ...
      className="data-[open=true]:flex data-[open=false]:hidden bg-gray-50 dark:bg-[#171717] transition-transform duration-700 relative min-w-[10vw] sm:min-w-[18vw] lg:w-[20vw] max-w-[80vw] sm:max-w-[40vw] border-r-[1px] border-[#ddd] dark:border-[#333] text-black dark:text-white text-xs sm:text-sm select-none text-nowrap"
    >
      <div
        id="dragger"
