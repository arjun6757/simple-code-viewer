...
export default function ExplorerPanel() {
  ...
  return (
    <div
      ...
      ref={treeRef}
      className={`
      ${isExplorerOpen ? "flex" : "hidden"} bg-white dark:bg-[#171717] transition-transform duration-700 relative min-w-[10vw] sm:min-w-[18vw] lg:w-[20vw] max-w-[80vw] sm:max-w-[40vw] border-r-[1px] border-[#ddd] dark:border-[#555] text-black dark:text-white text-xs sm:text-sm select-none text-nowrap`}
    >
      <div
        id="dragger"
