...
import { getRepoUrl, getDirData, getQueryData, getPinnedRepos, getSelectedRepoData, getHomePageURL } from '../controllers/repoController.js';
...
router.get('/code/repo/get/homepage_url', getHomePageURL);
